...
import { puckConfig, samplePuckData } from "@/lib/puck-config";

export default function PagePreviewIndex() {
  return (
    <>
      <style>{`
        ...
        .preview-bar__tag{background: rgba(194,143,80,0.2);color: #C28F50;font-size:.65rem;font-weight:600;padding:.2rem .6rem;border-radius:9999px;text-transform:uppercase;letter-spacing:.06em}
      ...
      <div className="preview-bar">
        <div className="preview-bar__left">
          ...
          <span className="preview-bar__label">Page Preview</span>
          <span className="preview-bar__tag">Sample Data</span>
        </div>
      ...
      <main className="preview-main">
        <Render config={puckConfig} data={samplePuckData as Data} />
      </main>
